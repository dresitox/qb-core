...
QBShared.Jobs = {
	...
	police = {
		...
		grades = {
			...
			['1'] = { name = 'Oficial I', payment = 75 },
			['2'] = { name = 'Sargento', payment = 100 },
			['3'] = { name = 'Teniente', payment = 125 },
			['4'] = { name = 'Superintendente', isboss = true, payment = 150 },
		},
	},
	ambulance = {
		label = 'EMS',
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'Residente', payment = 50 },
			['1'] = { name = 'Paramédico', payment = 75 },
			['2'] = { name = 'Enfermero', payment = 100 },
	...
	taxi = {
		...
		grades = {
			...
			['1'] = { name = 'Conductor novato', payment = 75 },
			['2'] = { name = 'Conductor experto', payment = 100 },
			['3'] = { name = 'Autobusero', payment = 125 },
	...
	mechanic = {
		...
		grades = {
			...
			['2'] = { name = 'Experto', payment = 100 },
			['3'] = { name = 'Avanzado', payment = 125 },
			['4'] = { name = 'Jefe', isboss = true, payment = 150 },
		},
	},
	mechanic2 = {
